# My AirDrop - seamless data transfer between devices
...
I took a Computer Networking class at Stony Brook last semester, and thought I should practice some C programming to build this functionality. I needed to create a simple protocol, broadcasting, and daemon to enable this feature. It is currently a work in progress, but once I finish up, I'll document the entire development process!
